            ...
            for viewpoint in ["frontview", "topview", "external_camera_0"]:
                for robot in ["default", "simplified"]:
                    for size in ["small", "medium", "large"]:
                        ...
                        register(
                            id='ReachSpecificRelativeTarget_{}Distractors_{}Targets_{}Reward_{}Obs_{}Viewpoint{}Robot-v1'.format(*[kwarg.title() if isinstance(kwarg, str) else kwarg for kwarg in [num_distractors, size, reward_type, obs_type, viewpoint, robot]]),
                            entry_point='visual_block_builder.env:ReachTargetEnv',
                            kwargs=kwargs,
                            max_episode_steps=50,
                        )
...
for num_distractors in range(4, 18):
    for reward_type in ['sparse', 'dense']:
        for obs_type in ['dictimage', 'np', 'dictstate']:
            for viewpoint in ["frontview", "topview", "external_camera_0"]:
                for robot in ["default", "simplified"]:
                    for size in ["small", "medium", "large"]:
                        ...
                        register(
                            id='ReachDistinctGroupsTarget_{}Distractors_{}Targets_{}Reward_{}Obs_{}Viewpoint{}Robot-v1'.format(*[kwarg.title() if isinstance(kwarg, str) else kwarg for kwarg in [num_distractors, size, reward_type, obs_type, viewpoint, robot]]),
                            entry_point='visual_block_builder.env:ReachTargetEnv',
                            kwargs=kwargs,
                            max_episode_steps=50,
                        )
                ...
                for robot in ["default", "simplified"]:
                    for target_size in ["small", "medium", "large"]:
                        for object_size in ["small", "medium", "large"]:
                            ...
                            register(
                                id='PushSpecificBlock_{}Blocks_{}Target_{}Objects_{}Reward_{}Obs_{}Viewpoint{}Robot-v1'.format(*[kwarg.title() if isinstance(kwarg, str) else kwarg for kwarg in [num_blocks, target_size, object_size, reward_type, obs_type, viewpoint, robot]]),
                                entry_point='visual_block_builder.env:PickAndPlaceBlockEnv',
                                kwargs=kwargs,
                                max_episode_steps=100,
                            )
                ...
                for robot in ["default", "simplified"]:
                    for target_size in ["small", "medium", "large"]:
                        for object_size in ["small", "medium", "large"]:
                            ...
                            register(
                                id='PushDistinctBlock_{}Blocks_{}Target_{}Objects_{}Reward_{}Obs_{}Viewpoint{}Robot-v1'.format(*[kwarg.title() if isinstance(kwarg, str) else kwarg for kwarg in [num_blocks, target_size, object_size, reward_type, obs_type, viewpoint, robot]]),
                                entry_point='visual_block_builder.env:PickAndPlaceBlockEnv',
                                kwargs=kwargs,
                                max_episode_steps=100,
                            )
