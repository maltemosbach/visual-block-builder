            ...
            for render_size in [42, 84]:
                for stack_only in [True, False]:
                    for case in ["Singletower", "Pyramid", "Multitower", "All"]:
                        ...
                        register(
                            id='VisualBlockBuilder_{}Blocks_{}Reward_{}Obs_{}Rendersize_{}Stackonly_{}Case-v1'.format(*[kwarg.title() if isinstance(kwarg, str) else kwarg for kwarg in [num_blocks, reward_type, obs_type, render_size, stack_only, case]]),
