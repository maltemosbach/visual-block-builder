        ...
        for obs_type in ['dictimage', 'np', 'dictstate']:
            for viewpoint in ["frontview", "topview", "external_camera_0"]:
                for robot in ["default", "simplified"]:
                    ...
                    register(
                        id='PickAndPlaceSpecificBlock_{}Blocks_{}Reward_{}Obs_{}Viewpoint{}Robot-v1'.format(*[kwarg.title() if isinstance(kwarg, str) else kwarg for kwarg in [num_blocks, reward_type, obs_type, viewpoint, robot]]),
        ...
        for obs_type in ['dictimage', 'np', 'dictstate']:
            for viewpoint in ["frontview", "topview", "external_camera_0"]:
                for robot in ["default", "simplified"]:
                    ...
                    register(
                        id='PickAndPlaceDistinctBlock_{}Blocks_{}Reward_{}Obs_{}Viewpoint{}Robot-v1'.format(*[kwarg.title() if isinstance(kwarg, str) else kwarg for kwarg in [num_blocks, reward_type, obs_type, viewpoint, robot]]),
                        entry_point='visual_block_builder.env:PickAndPlaceBlockEnv',
                        kwargs=kwargs,
                        max_episode_steps=100,
                    )
