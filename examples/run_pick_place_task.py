...
# Create environment.
env = gym.make(f'PickAndPlace{args.case}Block_{args.num_distractors}Blocks_SparseReward_DictstateObs_{args.viewpoint.title()}Viewpoint{args.robot.title()}Robot-v1')
